...
func (s *Service) QueryResList(
	...
	lastId uint64, size int64) (*QueryResult, error) {
...
func (s *Service) getLastId(list interface{}, total, size int64) uint64 {
	if total > size {
		return s.reflectLastId(list, size)
	}

	return 0
}

func (s *Service) reflectLastId(list interface{}, size int64) uint64 {
